...
const QUOTES = [
  {
    q: "My students ask to do BrightSpeaker during indoor recess. That's never happened for any speaking curriculum I've used.",
    who: "Ms. Rivera",
    role: "2nd grade teacher, Riverside USD",
    i: "R",
  },
  {
    q: "It turned my most anxious public speaker into our class's show-and-tell star. In six weeks.",
    who: "Mr. Okonkwo",
    role: "4th grade teacher, Summit K–5",
    i: "O",
  },
  {
    q: "Finally, a speaking tool where the video actually stays on the device. Our IT director signed the DPA same day.",
    who: "Dr. Chen",
    role: "Principal, Northbridge Elementary",
    i: "C",
  },
];
...
const FAQS = [
  {
    ...
    a: "No. Students join with a class code generated by the teacher. Optional SSO via Clever, ClassLink, or Google for Education is available for districts.",
  },
  {
    q: "Does the video really never leave the device?",
    a: "Correct. All pose and face analysis runs locally in the browser using Google's MediaPipe library. We only send aggregate metrics (e.g. duration spoken, eye-contact score) to the teacher dashboard — never video or audio.",
  },
  {
  ...
  },
  {
    ...
    a: "Prompts are available in English and Spanish. BrightSpeaker evaluates growth over time, not a fixed accent or speech target — we celebrate every student's own voice. For students with IEPs, teachers can adjust the metric weights per student.",
  },
];
    ...
    <div className="min-h-screen bg-[var(--cream)]">
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-10">
        <div className="text-center mb-3">
          <span className="eyebrow">Piloting in elementary schools across the U.S.</span>
        </div>
        <div className="flex gap-10 justify-center flex-wrap items-center py-8 text-[var(--ink-2)] opacity-65 font-display font-bold text-lg">
          <span>◉ Riverside USD</span>
          <span>✦ Northbridge Elementary</span>
          <span>◆ Summit K–5 Schools</span>
          <span>● Brookfield Charter</span>
          <span>▲ Greenfield ISD</span>
          <span>■ Wellspring Academy</span>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-[18px]">
            ...
            >
              <div className="p-7">
                ...
                <h3 className="mt-3.5 text-[22px]">Reads body language, not just voice</h3>
                <p className="text-[var(--ink-2)] text-[15px] mt-1.5">
                  MediaPipe pose + face landmarks track eye contact, posture, facial expression, pacing,
                  and volume — the five skills graders actually score.
                </p>
              </div>
              <div
            ...
            <div className="feature-card" style={{ background: "var(--coral)", color: "#fff" }}>
              <div className="text-[28px]">👩‍🏫</div>
              <h3 className="mt-3.5 text-[22px]" style={{ color: "#fff" }}>Teacher dashboard</h3>
              <p className="mt-1.5" style={{ color: "rgba(255,255,255,0.9)", fontSize: 15 }}>
                See who&apos;s practicing, flag students who need support, and export to your gradebook in
                one click.
              </p>
            </div>
            ...
            <div className="feature-card">
              <div className="text-[28px]">🌎</div>
              <h3 className="mt-3.5 text-[22px]">English &amp; Spanish prompts</h3>
              <p className="text-[var(--ink-2)] text-[15px] mt-1.5">
                Supports ELL and dual-language classrooms with bilingual activities and instructions.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            <div className="p-10 md:p-12">
              ...
              <div className="mt-7 flex gap-2 flex-wrap">
                {["COPPA friendly", "FERPA aligned", "SOPPA compliant", "Student Privacy Pledge signer"].map((label) => (
                  <span
                    key={label}
                    className="pill"
                    style={{
      ...
      <section className="py-24">
        <div className="max-w-[1280px] mx-auto px-6 md:px-10">
          <div className="text-center mb-14">
            <span className="eyebrow block mb-3.5">Teachers are seeing it</span>
            <h2 className="text-[clamp(34px,3.8vw,52px)]">&ldquo;The quiet ones find their voice first.&rdquo;</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-5">
            {QUOTES.map((q) => (
              <div key={q.i} className="quote">
                <span className="quote-mark">&ldquo;</span>
                <p className="m-0 text-[17px] leading-[1.45]">{q.q}</p>
                <div
                  className="flex gap-3 items-center mt-auto pt-3"
                  style={{ borderTop: "1.5px dashed var(--line)" }}
                >
                  <div className="quote-avatar">{q.i}</div>
                  <div className="text-[13px] text-[var(--ink-2)]">
                    <strong className="block text-[var(--ink)] text-sm">{q.who}</strong>
                    {q.role}
                  </div>
                </div>
              </div>
