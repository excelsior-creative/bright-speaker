...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: "/blog/how-to-teach-public-speaking-elementary-school", priority: 0.8, changeFrequency: "monthly" as const },
    { path: "/blog/five-minute-elementary-speaking-warmup", priority: 0.8, changeFrequency: "monthly" as const },
