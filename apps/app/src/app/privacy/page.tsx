  ...
  return (
    <div className="min-h-screen bg-warm-gradient">
      ...
      <main id="main" className="max-w-3xl mx-auto px-6 pt-8 pb-16">
        ...
        <h1 className="text-4xl font-extrabold text-foreground mb-3">Privacy &amp; data</h1>
        ...
        <section className="space-y-6 text-foreground/80 leading-relaxed">
          <h2 className="text-2xl font-extrabold text-foreground mt-4">What leaves the student&apos;s device</h2>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10">What we don&apos;t collect</h2>
          <ul className="space-y-3 list-disc pl-6">
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10">Who we work with (sub-processors)</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10">About COPPA and FERPA</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10">Deletion and questions</h2>
          <p>
            You can clear all session data for your browser from the{" "}
            <Link href="/history" className="text-warm-coral font-semibold hover:underline">
              history page
            </Link>
          ...
          <p>
            ...
            <Link href="/contact" className="text-warm-coral font-semibold hover:underline">
              here
            </Link>
            .
          </p>
